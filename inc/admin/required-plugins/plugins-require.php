...
function travelwp_register_required_plugins() {
	...
	$plugins     = array(
		...
		array(
			...
			'source'             => esc_url( $link_plugin ) . 'plugins/physc-vc-addon.zip',
			'version'            => '1.0.2',
			// The plugin source
			'required'           => true,
		...
		array(
			...
			'slug'               => 'revslider',
			// The plugin slug (typically the folder name)
			'source'             => esc_url( $link_plugin ) . 'plugins/revslider.zip',
			'version'            => '5.4.6.3.1',
			// The plugin source
			'required'           => false,
			// If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'slug'               => 'js_composer',
			// The plugin slug (typically the folder name)
			'source'             => esc_url( $link_plugin ) . 'plugins/js_composer.zip',
			'version'            => '5.4.5',
			// The plugin source
			'required'           => true,
			// If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'slug'               => 'travel-booking',
			// The plugin slug (typically the folder name)
			'source'             => esc_url( $link_plugin ) . 'plugins/travel-booking.zip',
			'version'            => '1.2.6',
			// The plugin source
			'required'           => true,
			// If false, the plugin is only 'recommended' instead of required
